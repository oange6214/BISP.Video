namespace BISP.Video.DirectShow.Wpf.Internals;
...
internal abstract class DSMarshaler : ICustomMarshaler
{
    ...
    public virtual object MarshalNativeToManaged(IntPtr ptrNativeData)
    {
        return this.obj;
    }

    // Release the  buffer
    public virtual void CleanUpNativeData(IntPtr ptrNativeData)
    {
...
internal class EMTMarshaler : DSMarshaler
{
    ...
    // Called just after invoking the COM method.  The IntPtr is the same one that just got returned
    // from MarshalManagedToNative.  The return value is unused.
    public override object MarshalNativeToManaged(IntPtr ptrNativeData)
    {
